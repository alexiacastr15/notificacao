package com.alexiadev.notificacao.business;


import com.alexiadev.notificacao.business.dto.TarefasDTO;
import com.alexiadev.notificacao.infrastructure.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto){
        try{
            ...
            mimeMessageHelper.setSubject("Notificação de Tarefa"); //assunto do email
